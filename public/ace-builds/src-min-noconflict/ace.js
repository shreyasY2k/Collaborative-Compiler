...
ace.define(
        "ace/lib/fixoldbrowsers", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/lib/useragent", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/lib/dom", ["require", "exports", "module", "ace/lib/useragent"],
        function(e, t, n) {
            "use strict";
            ...
            if (typeof document != "undefined") {
                ...
                t.HI_DPI &&
                    ...
                    (t.HAS_CSS_TRANSFORMS = !0), !r.isEdge &&
    ...
    ace.define(
        "ace/lib/oop", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/lib/keys", ["require", "exports", "module", "ace/lib/oop"],
        function(e, t, n) {
            "use strict";
            var r = e("./oop"),
                i = (function() {
    ...
    ace.define(
        "ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/lib/lang", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
            (t.last = function(e) {
                return e[e.length - 1];
    ...
    ace.define(
        "ace/clipboard", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
            var r;
            n.exports = {
                        ...
                        (this.focus = function() {
                            ...
                            if (t) {
                                ...
                                while (s && s.nodeType == 1)
                                    i.push(s),
                                    s.setAttribute("ace_nocontext", !0), !s.parentElement && s.getRootNode ?
    ...
    ace.define(
        "ace/mouse/default_handlers", ["require", "exports", "module", "ace/lib/useragent"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/tooltip", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/mouse/mouse_event", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent"],
        function(e, t, n) {
            "use strict";
            var r = e("../lib/event"),
                i = e("../lib/useragent"),
    ...
    ace.define(
        "ace/lib/net", ["require", "exports", "module", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
            var r = e("./dom");
            (t.get = function(e, t) {
    ...
    ace.define(
        "ace/lib/event_emitter", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
            var r = {},
                i = function() {
    ...
    ace.define(
        "ace/lib/app_config", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter"],
        function(e, t, n) {
            "no use strict";
    ...
    ace.define(
        ...
        function(e, t, n) {
            ...
            function c(r) {
                ...
                f.packaged =
                    r || e.packaged || n.packaged || (a.define && define.packaged);
                var i = {},
                    s = "",
                    o = document.currentScript || document._currentScript,
                    u = (o && o.ownerDocument) || document,
                    l = u.getElementsByTagName("script");
                for (var c = 0; c < l.length; c++) {
                    ...
                    for (var m = 0, g = v.length; m < g; m++) {
                        ...
                        y.name.indexOf("data-ace-") === 0 &&
                            (i[h(y.name.replace(/^data-ace-/, ""))] = y.value);
                    }
            ...
            (t.loadModule = function(n, r) {
                ...
                s.loadScript(t.moduleUrl(n, o), a), l();
            });
            var l = function() {
                !f.basePath &&
                    !f.workerPath &&
                    !f.modePath &&
                    !f.themePath &&
                    !Object.keys(f.$moduleUrls).length &&
                    (console.error(
    ...
    ace.define(
        "ace/mouse/fold_handler", ["require", "exports", "module", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/keyboard/keybinding", ["require", "exports", "module", "ace/lib/keys", "ace/lib/event"],
        function(e, t, n) {
            "use strict";
            var r = e("../lib/keys"),
                i = e("../lib/event"),
                    ...
                    (this.removeKeyboardHandler = function(e) {
                        ...
                        return t == -1 ?
                            ...
                            (this.$handlers.splice(t, 1),
                                e.detach && e.detach(this.$editor), !0);
                    }),
    ...
    ace.define(
        "ace/lib/bidiutil", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/bidihandler", ["require", "exports", "module", "ace/lib/bidiutil", "ace/lib/lang"],
        function(e, t, n) {
            "use strict";
            ...
            (function() {
                    ...
                    (this.setRtlDirection = function(e, t) {
                        ...
                        for (var r = e.selection.getSelectionAnchor().row; r <= n.row; r++)
                            ...
                            e.session.doc.insert({ column: 0, row: r },
                                e.session.$bidiHandler.RLE
                            );
                    }),
            ...
            var r = e("./lib/oop"),
                ...
                u = function(e) {
                    ...
                    this.cursor.on("change", function(e) {
                            (t.$cursorChanged = !0),
                            t.$silent || t._emit("changeCursor"), !t.$isEmpty && !t.$silent && t._emit("changeSelection"), !t.$keepDesiredColumnOnChange &&
    ...
    ace.define(
        "ace/tokenizer", ["require", "exports", "module", "ace/config"],
        function(e, t, n) {
            "use strict";
            var r = e("./config"),
                i = 2e3,
                    ...
                    for (var t in this.states) {
                        ...
                        for (var a = 0; a < n.length; a++) {
                            ...
                            Array.isArray(f.token) ?
                                ...
                                c - 1 != f.token.length ?
                                (this.reportError(
                                        "number of classes and regexp groups doesn't match", { rule: f, groupCount: c - 1 }
                                    ),
                                    (f.token = f.token[0])) :
                                ...
                                (/\\\d/.test(f.regex) ?
                                    ...
                                    ((c = 1), (l = this.removeCapturingGroups(f.regex))), !f.splitRegex && typeof f.token != "string" && u.push(f)),
                                (s[i] = a),
                                (i += c),
                                r.push(l),
            ...
            (function() {
                    ...
                    (this.getLineTokens = function(e, t) {
                        ...
                        return (
                            h.type && f.push(h),
                            n.length > 1 && n[0] !== r && n.unshift("#tmp", r), { tokens: f, state: n.length ? n : r }
                        );
                    }),
    ...
    ace.define(
        "ace/mode/text_highlight_rules", ["require", "exports", "module", "ace/lib/lang"],
        function(e, t, n) {
            "use strict";
            var r = e("../lib/lang"),
                i = function() {
                    ...
                    (this.normalizeRules = function() {
                        function i(s) {
                            ...
                            for (var u = 0; u < o.length; u++) {
                                var a = o[u],
                                    f = null;
                                Array.isArray(a) && ((f = a), (a = {})), !a.regex &&
                                    a.start &&
                                    ((a.regex = a.start),
                                        a.next || (a.next = []),
                                        a.next.push({ defaultToken: a.token }, {
                                            token: a.token + ".end",
                                            regex: a.end || a.start,
                                            next: "pop",
                                        }),
    ...
    ace.define(
        "ace/mode/behaviour", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
            var r = function() {
                this.$behaviours = {};
    ...
    ace.define(
        "ace/token_iterator", ["require", "exports", "module", "ace/range"],
        function(e, t, n) {
            "use strict";
            var r = e("./range").Range,
                i = function(e, t, n) {
                        ...
                        this.add("parens", "insertion", function(e, t, n, r, i) {
                            if (i == "(") {
                                ...
                                if (d.isSaneInsertion(n, r))
                                    return (
                                        d.recordAutoInsert(n, r, ")"), { text: "()", selection: [1, 1] }
                                    );
                            } else if (i == ")") {
                                h(n);
    ...
    ace.define(
        "ace/unicode", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
            var r = [
    ...
    ace.define(
        "ace/apply_delta", ["require", "exports", "module"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/anchor", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter"],
        function(e, t, n) {
            "use strict";
            var r = e("./lib/oop"),
                    ...
                    r.implement(this, s),
                        ...
                        (this.clippedPos = function(e, t) {
                            ...
                            return (
                                ...
                                (t = Math.min(Math.max(t, 0), r.length)), { row: e, column: t }
                            );
                        }),
    ...
    ace.define(
        "ace/background_tokenizer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter"],
        function(e, t, n) {
            "use strict";
            var r = e("./lib/oop"),
                i = e("./lib/event_emitter").EventEmitter,
    ...
    ace.define(
        "ace/edit_session/fold_line", ["require", "exports", "module", "ace/range"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/range_list", ["require", "exports", "module", "ace/range"],
        function(e, t, n) {
            "use strict";
            var r = e("./range").Range,
                i = r.comparePoints,
    ...
    ace.define(
        "ace/edit_session/fold", ["require", "exports", "module", "ace/range_list", "ace/lib/oop"],
        function(e, t, n) {
            "use strict";
            ...
            function u() {
                ...
                (this.toggleFold = function(e) {
                    ...
                    if (n.isEmpty()) {
                        ...
                        n.comparePoint(i) == 1 ?
                            (n.end = i) :
                            ((n.start = i), n.start.column++, n.end.column--): (i = this.findMatchingBracket({
                                row: s.row,
                                column: s.column + 1,
                            })) ?
    ...
    ace.define(
        "ace/edit_session/bracket_match", ["require", "exports", "module", "ace/token_iterator", "ace/range"],
        function(e, t, n) {
            "use strict";
            ...
            function() {
                ...
                r.implement(this, u),
                    ...
                    (this.onChange = function(e) {
                        ...
                        !this.$fromUndo &&
                            ...
                            (t &&
                                t.length &&
                                (this.$undoManager.add({ action: "removeFolds", folds: t },
                ...
                (this.getRowLength = function(e) {
                    ...
                    return (
                        this.lineWidgets &&
                        (t +=
                            (this.lineWidgets[e] && this.lineWidgets[e].rowCount) || 0), !this.$useWrapMode || !this.$wrapData[e] ?
                        t :
                ...
                (this.documentToScreenPosition = function(e, t) {
                    ...
                    return (
                        ...
                        (r += this.lineWidgets[u].rowsAbove), { row: r, column: v + this.$getStringScreenWidth(d)[0] }
                    );
                }),
    ...
    ace.define(
        "ace/keyboard/hash_handler", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"],
        function(e, t, n) {
            "use strict";
                ...
                (this.parseKeys = function(e) {
                    ...
                    for (var o = t.length; o--;) {
                        ...
                        if (u == null)
                            return (
                                typeof console != "undefined" &&
                                console.error("invalid modifier " + t[o] + " in " + e), !1
                            );
                        s |= u;
                    }
    ...
    ace.define(
        "ace/commands/default_commands", ["require", "exports", "module", "ace/lib/lang", "ace/config", "ace/range"],
        function(e, t, n) {
            "use strict";
            ...
            function() {
                r.implement(this, d),
                    ...
                    (this.getCopyText = function() {
                        ...
                        var o = { text: e };
                        return (
                            this._signal("copy", o), (b.lineMode = n ? o.text : !1), o.text
                        );
                    }),
                    ...
                    (this.applyComposition = function(e, t) {
                        if (t.extendLeft || t.extendRight) {
                            ...
                            n.start.column < 0 &&
                                ...
                                this.selection.setRange(n), !e && !n.isEmpty() && this.remove();
                        }
    ...
    ace.define(
        "ace/undomanager", ["require", "exports", "module", "ace/range"],
        function(e, t, n) {
            "use strict";
    ...
    ace.define(
        "ace/layer/lines", ["require", "exports", "module", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
            var r = e("../lib/dom"),
                i = function(e, t) {
            ...
            (function() {
                    (this.moveContainer = function(e) {
                        r.translate(
                            this.element,
                            0, -((e.firstRowScreen * e.lineHeight) % this.canvasHeight) -
    ...
    ace.define(
        "ace/layer/marker", ["require", "exports", "module", "ace/range", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
            var r = e("../range").Range,
                i = e("../lib/dom"),
    ...
    ace.define(
        "ace/layer/cursor", ["require", "exports", "module", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
            var r = e("../lib/dom"),
                i = function(e) {
    ...
    ace.define(
        "ace/renderloop", ["require", "exports", "module", "ace/lib/event"],
        function(e, t, n) {
            "use strict";
            var r = e("./lib/event"),
                i = function(e, t) {
        ...
        function(e, t, n) {
            ...
            var y = function(e, t) {
                ...
                i.addCssClass(this.container, "ace_editor"),
                    ...
                    this.setTheme(t),
                    s.get("useStrictCSP") == null && s.set("useStrictCSP", !1),
            ...
            (function() {
                    ...
                    r.implement(this, d),
                        ...
                        (this.onGutterResize = function(e) {
                            ...
                            t != this.gutterWidth &&
                                (this.$changes |= this.$updateCachedSize(!0,
                                    t,
                                    this.$size.width,
                                    this.$size.height
                                )),
                        ...
                        (this.$computeLayerConfig = function() {
                            ...
                            var f = t.scrollerHeight + this.lineHeight,
                                l = !this.$maxLines && this.$scrollPastEnd ?
    ...
    ace.define(
        "ace/mouse/multi_select_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent"],
        function(e, t, n) {
            function s(e, t) {
                return e.row == t.row && e.column == t.column;
            }
    ...
    ace.define(
        "ace/commands/multi_select_commands", ["require", "exports", "module", "ace/keyboard/hash_handler"],
        function(e, t, n) {
            (t.defaultCommands = [{
                    name: "addCursorAbove",
    ...
    ace.define(
        "ace/mode/folding/fold_mode", ["require", "exports", "module", "ace/range"],
        function(e, t, n) {
            "use strict";
            var r = e("../../range").Range,
    ...
    ace.define(
        "ace/theme/textmate", ["require", "exports", "module", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
            (t.isDark = !1),
            (t.cssClass = "ace-tm"),
    ...
    ace.define(
        "ace/line_widgets", ["require", "exports", "module", "ace/lib/dom"],
        function(e, t, n) {
            "use strict";
            ...
            (function() {
                    (this.getRowLength = function(e) {
                        ...
                        return (
                            ...
                            (t = 0), !this.$useWrapMode || !this.$wrapData[e] ?
                            1 + t :
